...
namespace VsixTesting
{
    internal interface IInstanceSettings
    {
        ...
        /// The default value is <see langword="false"></see> because if it's set to <see langword="true"></see> then "xunit.AppDomain" must be set to <see langword="denied" /> as well.
        /// </summary>
